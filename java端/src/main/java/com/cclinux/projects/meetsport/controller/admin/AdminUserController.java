...
import com.cclinux.projects.meetsport.service.admin.AdminUserService;
...
@RestController("MeetSportAdminUserController")
public class AdminUserController extends BaseMyAdminController {

    @Resource(name = "MeetSportAdminUserService")
