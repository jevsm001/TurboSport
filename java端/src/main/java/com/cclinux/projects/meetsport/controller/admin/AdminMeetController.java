...
import com.cclinux.projects.meetsport.service.admin.AdminMeetService;
...
@RestController("MeetSportAdminMeetController")
public class AdminMeetController extends BaseMyAdminController {

    @Resource(name = "MeetSportAdminMeetService")
