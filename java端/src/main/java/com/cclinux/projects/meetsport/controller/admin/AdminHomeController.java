...
import com.cclinux.projects.meetsport.service.admin.AdminHomeService;
...
@RestController("MeetSportAdminHomeController")
public class AdminHomeController extends BaseMyAdminController {

    @Resource(name = "MeetSportAdminHomeService")
