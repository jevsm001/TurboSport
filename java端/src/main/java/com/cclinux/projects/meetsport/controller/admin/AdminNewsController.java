...
import com.cclinux.projects.meetsport.service.admin.AdminNewsService;
...
@RestController("MeetSportAdminNewsController")
public class AdminNewsController extends BaseMyAdminController {

    @Resource(name = "MeetSportAdminNewsService")
