...
-- ----------------------------
-- Table structure for meetsport_admin
-- ----------------------------
DROP TABLE IF EXISTS `meetsport_admin`;
CREATE TABLE `meetsport_admin`  (
...
-- ----------------------------
DROP TABLE IF EXISTS `meetsport_fav`;
...
-- ----------------------------
-- Table structure for meetsport_meet
-- ----------------------------
DROP TABLE IF EXISTS `meetsport_meet`;
...
-- ----------------------------
-- Table structure for meetsport_meet_join
-- ----------------------------
DROP TABLE IF EXISTS `meetsport_meet_join`;
...
-- ----------------------------
-- Table structure for meetsport_news
-- ----------------------------
DROP TABLE IF EXISTS `meetsport_news`;
CREATE TABLE `meetsport_news`  (
...
-- ----------------------------
-- Table structure for meetsport_setup
-- ----------------------------
DROP TABLE IF EXISTS `meetsport_setup`;
CREATE TABLE `meetsport_setup`  (
...
-- ----------------------------
-- Table structure for meetsport_user
-- ----------------------------
DROP TABLE IF EXISTS `meetsport_user`;
CREATE TABLE `meetsport_user`  (
